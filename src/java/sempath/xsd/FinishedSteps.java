 ...
 */
public class FinishedSteps implements java.io.Serializable {
    ...
    public FinishedSteps() 
     {
        super();
        _stepList = new Vector();
    } //-- sempath.xsd.FinishedSteps()
     ...
     */
    public static sempath.xsd.FinishedSteps unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (sempath.xsd.FinishedSteps) Unmarshaller.unmarshal(sempath.xsd.FinishedSteps.class, reader);
    } //-- sempath.xsd.FinishedSteps unmarshal(java.io.Reader) 
